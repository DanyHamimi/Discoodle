    ...
    socket.on('OldSend', function(name, msg, hour, channel, prPic) {
        ...
        if (node != null) {
            if (msg.substring(0, 4) == "img/") {
                node.insertAdjacentHTML('beforeend', '<div class="message"> <div class="icon"><img class="responsive-img" src="' + prPic + '"/></div> <div class="body"> <div class="user-name">' + name + '</div><div class="hour">' + hour + '</div> <img style="max-width: 200px;"src=./' + msg + '></div> </div>');
            } else {
